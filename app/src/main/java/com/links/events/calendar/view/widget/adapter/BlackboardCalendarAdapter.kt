package com.links.events.calendar.view.widget.adapter
...
class BlackboardCalendarAdapter(private val context: Context) : RecyclerView.Adapter<BlackboardCalendarAdapter.ViewHolder>() {
    private val descriptions = mutableListOf<String>()


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.item_blackboard_calendar, parent, false)
